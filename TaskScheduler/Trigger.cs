...
//			base.SyncTrigger();
	...
	/// <summary>
	/// Trigger that fires every specified hours.
	/// </summary>
	public class HourlyTrigger : StartableTrigger 
	{
		/// <summary>
		/// Create a HourlyTrigger that fires every specified hours.
		/// </summary>
		/// <param name="hoursInterval">Date and time to fire.</param>
		public HourlyTrigger(short hoursInterval) : base() 
		{
			short hour;
			short minutes;
			hour=1;
			...
			taskTrigger.Data.daily.DaysInterval = (ushort)1;
			taskTrigger.MinutesDuration=1440;
			taskTrigger.MinutesInterval=(uint)60*(uint)hoursInterval;
		}
		...
		/// </summary>
		/// <param name="iTrigger">ITaskTrigger from system Task Scheduler.</param>
		internal HourlyTrigger(ITaskTrigger iTrigger) : base(iTrigger) 
		{
		}
	}
